    ...
    <header className='w-full bg-fixed '>
      ...
      <section className=' flex flex-col justify-center items-center pt-8 px-4 sm:pt-32'>
        <div className='  max-w-6xl w-full  '>
          ...
          <div className="">
          <h1 className='text-lg sm:text-4xl text-white rellax' data-rellax-speed="10">
          ...
          <p className=" leading-loose text-white pr-20 text-xs sm:text-sm pt-4 rellax " data-rellax-speed="5">
            ...
            veritatis. Explicabo, cupiditate hic! Accusantium nobis vitae
            maiores quas, adipisci dolore, deleniti dignissimos ipsa, delectus
            architecto optio nostrum doloremque veniam debitis?
          </p>
          </div>
          </div>
          ...
          <div className="flex justify-center items-center pt-8 sm:pt-32 text-white">
           ...
           <div className=" w-48 h-64 rounded-lg rellax" data-rellax-speed="1" data-rellax-xs-speed="3" style={{backgroundImage:"url("+ image1 +")",backgroundPosition:'center',backgroundSize:"cover"}}>
             <p className="bg-orange-600 capitalize p text-xs sm:text-sm ">building software</p>
           </div>
           ...
           <p className="bg-orange-600 capitalize p text-xs sm:text-sm ">changing lives</p>
           </div>
           ...
           <p className="bg-orange-600 capitalize p text-xs sm:text-sm ">dedicated developers</p>
           </div>
              </div>
          </div>
        </div>
