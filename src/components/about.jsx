      ...
      <div className='flex flex-col justify-center items-center'>
        <div className=' max-w-6xl w-full '>
          ...
          <section className='pt-16 sm:pt-32'>
            <h1 className='text-gray-900 text-sm text-center'>Our Goals</h1>
            <div className='pt-16'>
              <div className='grid-3'>
                <div
                  className='shadow-lg bg-white rounded-lg ronded-lg border-0 rellax'
                  data-rellax-speed='1'
                  data-rellax-xs-speed='0'
                >
                  <div
                    className='pt-8 w-full h-64 rounded-t-lg rounded-t-lg'
                    style={{
                  ...
                  ></div>
                  <div className='p'>
                    <h1 className='text-green-700 pt-8 font-bold text-lg'>
                      Vision
                    </h1>
                ...
                >
                  <div
                    className='pt-8 w-full h-64 rounded-t-lg'
                    style={{
                  ...
                  <div className='p'>
                    ...
                    <p className='pt-8 text-sm '>
                      Our Mission is to use technology to solve the world
                      challenges.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className='p'>
                    ...
                    <p className='pt-8 text-sm '>
                      Our Commitment is our integrity in building communities
                      through innovation
                    </p>
                  </div>
                </div>
